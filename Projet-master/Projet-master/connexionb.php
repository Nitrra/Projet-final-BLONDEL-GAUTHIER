	...
	<body>
	 <?php
			/*************************************************************************
				...
				Description : cescript sous formulaire,
				              si le paramètre sont correcte on enregistre l'email dans
							  une variable de session et on indique qu'il est connecter
					...
					if($result = mysqli_query($conn, $req))
					{
						...
						*/
						...
						if ($nbLignes==1)
						{
							...
							if (password_verify('bibliotheque', $Mdp_crypt_BD)) 
							{
								...
								echo 'Vous êtes connecté vous avez accès au site de la bibliothèque <BR> !';
								echo '<a href="indexb.html"> paage de la bibliothèque </a>';
							} 					
							else 
							{
